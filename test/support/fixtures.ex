...
defmodule Fwup.TestSupport.Fixtures do
  ...
  """
  @spec get_public_key(Path.t()) :: binary()
  ...
  """
  @spec create_firmware(Path.t(), map()) :: {:ok, Path.t()}
  ...
  """
  @spec sign_firmware(Path.t(), Path.t(), Path.t()) :: {:ok, Path.t()}
  ...
  """
  @spec create_signed_firmware(Path.t(), Path.t(), Path.t(), map()) :: {:ok, Path.t()}
  ...
  """
  @spec corrupt_firmware_file(Path.t(), Path.t()) :: {:ok, Path.t()}
